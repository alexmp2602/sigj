  ...
  return (
      <div className="max-w-7xl mx-auto rounded-lg p-6">
        <header className="mb-6">
          <h1 className="text-xl lg:text-3xl font-bold text-gray-800 dark:text-gray-100 mb-2 flex items-center">
            <FiClock className="mr-2" aria-hidden="true" />
        ...
        <div className="flex gap-2 flex-wrap mb-4">
          {searchQuery && (
            <span className="bg-blue-100 text-blue-700 px-3 py-1 rounded-full text-sm">
              ...
              <button onClick={() => setSearchQuery("")} className="ml-2 text-blue-500">
                ×
              </button>
            </span>
          )}
          {filterType && (
            <span className="bg-green-100 text-green-700 px-3 py-1 rounded-full text-sm">
              Tipo: {filterType}{" "}
              <button onClick={() => setFilterType("")} className="ml-2 text-green-500">
                ×
              </button>
            </span>
          )}
          {filterDate && (
            <span className="bg-purple-100 text-purple-700 px-3 py-1 rounded-full text-sm">
              Fecha: {filterDate}{" "}
              <button onClick={() => setFilterDate("")} className="ml-2 text-purple-500">
                ×
              </button>
            </span>
          )}
          {filterUser && (
            <span className="bg-yellow-100 text-yellow-700 px-3 py-1 rounded-full text-sm">
              Usuario: {filterUser}{" "}
              <button onClick={() => setFilterUser("")} className="ml-2 text-yellow-500">
                ×
              </button>
            </span>
          )}
